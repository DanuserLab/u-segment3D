...
if __name__=="__main__":
    ...
    This script will demo how to use u-Segment3D with pretrained Cellpose 2D models auto-predicted optimal diameter but parse 2D segmentations with u-Segment3D still, 
    then use indirect method to aggregate them together into a single 3D segmentation from one orthogonal view (xy)
    ...
    # cellpose_segment_params['ksize'] = 21 # we will use cellpose's own diameter tuning. 
...
# =============================================================================
    ...
    final_mask = uSegment3D_filters.largest_component_vol_labels_fast(final_mask)
