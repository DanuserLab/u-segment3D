...
if __name__=="__main__":
    ...
    to generate 3D segmentation for a single cell with surface lamellipodia.
    ...
    imgfile = '../../example_data/single_cells/lamellipodia/decon_1_1.tif'
    ...
    uSegment3D_fio.save_segmentation(os.path.join(savecellfolder,
                                                  'uSegment3D_lamellipodia_labels.tif'), segmentation3D)
    ...
    uSegment3D_fio.write_pickle(os.path.join(savecellfolder,
                                                  'uSegment3D_lamellipodia_3Dcombined_probs_and_gradients'), 
    ...
    label_diffusion_params['diffusion']['refine_alpha'] = 0.7 # bias towards image
    ...
    uSegment3D_fio.save_segmentation(os.path.join(savecellfolder,
                                                  'uSegment3D_lamellipodia_labels_postprocess-diffuse.tif'), segmentation3D_filt_diffuse)
    ...
    guided_filter_params['guide_filter']['radius'] = 55 # drop lower (this should be approx size of protrusions) 
    ...
    guided_filter_params['guide_filter']['base_erode'] = 3
    ...
    uSegment3D_fio.save_segmentation(os.path.join(savecellfolder,
                                                  'uSegment3D_lamellipodia_labels_postprocess-diffuse-guided_filter.tif'), segmentation3D_filt_guide)
    ...
    tmp = cell_surface_mesh.export(os.path.join(savecellfolder,
                                                  'uSegment3D_lamellipodia_labels_postprocess-diffuse-guided_filter_surface-mesh.obj'))
