...
if __name__=="__main__":
    ...
    to generate 3D segmentation for a single cell with surface blebs.
    ...
    imgfile = '../../example_data/single_cells/blebs/decon_1_1.tif'
    ...
    label_diffusion_params['diffusion']['refine_alpha'] = 0.75 # bias towards image-driven 
    ...
    guided_filter_params['guide_filter']['radius'] = 45 # drop lower (this should be approx size of protrusions) 
    ...
    tmp = cell_surface_mesh.export(os.path.join(savecellfolder,
                                                  'uSegment3D_blebs_labels_postprocess-diffuse-guided_filter_surface-mesh.obj'))
